...
public class MateriPengukuranDebit extends Activity implements OnClickListener,
	...
	@SuppressLint("NewApi")
	private class GetMateriPengukuranDebit extends AsyncTask<String, String, String> {
		// private String subJudul;
		// private String anakSubBab;
		// private String isiMateri;
		...
		protected void onPreExecute() {
			...
			mProgressDialog.setMessage("Memuat Materi Pengukuran Debit. Silahkan Tunggu!");
