...
public class MateriMengolahData extends Activity implements OnClickListener,
	...
	private static final String LINK_URL = "http://elearningmath.nazuka.net/jsonmengolahdata.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// findViewById(R.id.txtViewMateriMengolahData);
	 ...
	 */
	// @SuppressLint("NewApi")
	protected class GetMateriMengolahData extends
		...
		protected void onPreExecute() {
			...
			mProgressDialog
					.setMessage("Memuat Materi Mengolah Data. Silahkan Tunggu!");
